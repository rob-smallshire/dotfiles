...
var read = function read(callback) {
...
var write = function write(data, callback) {
	try {
...
var alter = function alter(fn, callback) {
...
var compareProject = function compareProject(project) {
	return Project.equals(this, project);
};

var sortProjects = function sortProjects(projects) {
...
module.exports = {
	add: function add(project, callback) {
		if (_instanceof(!project, Project)) {
	...
	update: function update(project, callback) {
		if (_instanceof(!project, Project)) {
	...
	remove: function remove(project, callback) {
		if (_instanceof(!project, Project)) {
